...
CHALLENGES faced: while setting time. Though figured out that HH is used for denoting military time,instead of hh. To understand how the moment()function works.
